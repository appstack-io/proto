...
export interface Test1ServiceImplementation<CallContextExt = {}> {
  createOne(
    request: Test1CreateOneInput,
    context: CallContext & CallContextExt,
  ): Promise<DeepPartial<Test1>>;
}

export interface Test1ServiceClient<CallOptionsExt = {}> {
  createOne(
    request: DeepPartial<Test1CreateOneInput>,
...
export interface Test2ServiceImplementation<CallContextExt = {}> {
  createOne(
    request: Test2CreateOneInput,
    context: CallContext & CallContextExt,
  ): Promise<DeepPartial<Test2>>;
}

export interface Test2ServiceClient<CallOptionsExt = {}> {
  createOne(
    request: DeepPartial<Test2CreateOneInput>,
    options?: CallOptions & CallOptionsExt,
  ): Promise<Test2>;
}
